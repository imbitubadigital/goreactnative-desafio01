...
Como desafio foi proposto criar uma aplicação do zero e configure o ESLint, EditorConfig, Reactotron, React DevTools e Babel Root Import. Assim que configurados, reproduzuzimos o layout abaixo utilizando FlexBox layout:
